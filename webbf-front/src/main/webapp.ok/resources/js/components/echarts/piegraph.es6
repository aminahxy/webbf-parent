...
export default class PieGraph extends React.Component{
  ...
  constructor(props) {
      super(props);
      this.initPiegraph = this.initPiegraph.bind(this)
  }
  initPiegraph(){
    this.chartData = {};
  ...
  autoResize() {
    var piegraph = document.getElementById('piegraph-chart');
  ...
  componentDidMount() {
    ...
    var myChart = echarts.init(document.getElementById('piegraph-chart'));
    // 绘制图表
    myChart.setOption({
        // title: {
        //     text: '1小时访问来源堆积图'
