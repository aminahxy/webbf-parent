...
// import Toggle from "../user/toggle.es6";
// import Thumb from "./assets/thumbnaildiv.png";
  ...
  render() {
    ...
    return (
        ...
        <div className="main-div">
            {/*<div style="position:absolute;width:100%;top:0;bottom:0;backgroung:#000"></div>*/}
            <div className="main-top">日志平台系统Demo</div>
            {/*<div style="position:absolute;width:100%;top:0;bottom:0;backgroung:#000">*/}
            <div className="well" style={wellStyles}>
            <Row type="flex" justify="start">
                <Col span="4">
                    <div className="labelha">
